...
def main():
    ...
    keys,data,label=test_loader.__iter__().__next__()
    print 'keys=',keys,'data=',data,'label=',label
    print '****'*20
    """
    sample,lables=train_loader.__iter__().__next__()
    print 'lables=',lables,'sample=',sample
    print '***'*30
    sample,lables=train_loader.__iter__().__next__()
    print 'lables=',lables,'sample=',sample
    print '***'*30
...
class Spatial_CNN():
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/spatial/spatial_video_preds_resnet18_var.pickle','wb') as f:
            ...
            },is_best,'record/spatial/checkpoint.pth_resnet18_var.tar','record/spatial/model_best.pth_resnet18_var.tar')
    ...
    def train_1epoch(self):
        ...
        record_info(info, 'record/spatial/rgb_train_resnet18_var.csv','train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, 'record/spatial/rgb_test_resnet18_var.csv','test')
