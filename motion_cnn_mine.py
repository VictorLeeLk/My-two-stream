...
def main():
    ...
    #Prepare DataLoader
    data_loader = dataloader.Motion_DataLoader_lk(
                        ...
                        ucf_list='/home/victorleelk/MyPro/two-stream-action-recognition-master/UCF_list/',
                        ucf_split='01',
                        in_channel=10,
                        )
...
class Motion_CNN():
    ...
    def build_model(self):
        ...
        #self.model.fc_custom = nn.Linear(512,51)
    ...
    def run(self):
        ...
        for self.epoch in range(self.start_epoch, self.nb_epochs):
            ...
            if is_best:
                ...
                with open('record/motion/motion_video_preds_resnet18_2.pickle','wb') as f:
            ...
            },is_best,'record/motion/checkpoint.pth_resnet18_2.tar','record/motion/model_best_mine.pth_resnet18_2.tar')
    ...
    def train_1epoch(self):
        ...
        for i, (data_dic,label) in enumerate(progress):
            #print 'i=',i
            #print 'data_dic=',data_dic
            #print label
            #print len(data_dic['img1'])
        ...
        record_info(info, 'record/motion/opf_train_mine_resnet18_2.csv','train')
    ...
    def validate_1epoch(self):
        ...
        record_info(info, 'record/motion/opf_test_mine_2.csv','test')
