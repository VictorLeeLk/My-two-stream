...
class Motion_DataLoader():
    ...
    def load_frame_count(self):
        ...
        with open('/home/victorleelk/two-stream-from-github/two-stream-action-recognition-master/dataloader/dic/frame_count.pickle','rb') as file:
    ...
    def val_sample19(self):
        ...
        for video in self.test_video:
            ...
            sampling_interval = int((self.frame_count[video]-10+1)/5)
