...
class spatial_dataset(Dataset):  
    ...
    def load_ucf_image(self,video_name, index):
        ...
        img = Image.open(path +'%06d.jpg'%index)
    ...
    def __getitem__(self, idx):
        ...
        if self.mode == 'train':
            ...
            """
            clips = []  #lk
            clips.append(random.randint(1, nb_clips/4))
            clips.append(random.randint(nb_clips/4, nb_clips*2/4))
            clips.append(random.randint(nb_clips*2/4, nb_clips*3/4))
            clips.append(random.randint(nb_clips*3/4, nb_clips+1))
