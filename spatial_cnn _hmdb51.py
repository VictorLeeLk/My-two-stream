...
def main():
    ...
    data_loader = dataloader.spatial_dataloader(
                        ...
                        num_workers=8,
                        path='/media/victorleelk/Elements/DownLoad_Search/chrome/jpegs_256',
                        ucf_list ='/media/victorleelk/Elements/Keras_Project_Dataset/datasets/hmdb51_test_train_splits//testTrainMulti_7030_splits/',
                        ucf_split ='1', 
                        )
